...
export default function Edit({ certification }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        name: {
            en: certification.name?.en ?? "",
            fr: certification.name?.fr ?? "",
            fa: certification.name?.fa ?? "",
        },
        issuing_body: {
            en: certification.issuing_body?.en ?? "",
            fr: certification.issuing_body?.fr ?? "",
            fa: certification.issuing_body?.fa ?? "",
        },
        description: {
            en: certification.description?.en ?? "",
            fr: certification.description?.fr ?? "",
            fa: certification.description?.fa ?? "",
        },
    ...
    return (
        ...
        >
            <Head
                title={`${at("edit", uiLocale)} — ${certification.name?.en}`}
            />
