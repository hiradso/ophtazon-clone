...
const statusColor = {
    ...
    pending_review: 'bg-status-pending/15 text-status-pending border-status-pending/30',
            ...
            <div className="py-8">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="mb-6 flex items-center justify-between">
                        ...
                        <Button render={<Link href={route('admin.products.create')} />}>
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {productToDelete && (
                                <>
                                    "{productToDelete.title.en}" will be moved to trash and can be
