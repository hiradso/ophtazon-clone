const translations = {
    en: {
        ...
        sitemap_intro: "All the pages on our site, in one place.",
        sitemap_main_pages: "Main pages",
        sitemap_categories: "Product categories",
        ...
        certified_and_licensed: "Certified & licensed",
        our_team: "Our Team",
        our_team_intro: "The people behind Ophtazon.",
        our_team_empty: "Team profiles are coming soon.",
        ...
        toggle_currency: "Change currency",
        theme_light: "Light",
        theme_dark: "Dark",
        theme_system: "System",
    ...
    fr: {
        ...
        sitemap_intro: "Toutes les pages de notre site, au même endroit.",
        sitemap_main_pages: "Pages principales",
        sitemap_categories: "Catégories de produits",
        ...
        certified_and_licensed: "Certifié et agréé",
        our_team: "Notre équipe",
        our_team_intro: "Les personnes derrière Ophtazon.",
        our_team_empty: "Les profils de l'équipe arrivent bientôt.",
        ...
        checked_by_ophtazon: "Vérifié par Ophtazon",
        manufacture_year: "Année de fabrication",
        description_title: "Description",
        related_equipment: "Équipements similaires",
        reference_label: "Réf :",
        warranty: "Garantie",
        months_suffix: "mois",
        results: "résultats",
        ...
        unset_default: "Retirer par défaut",
        ...
        select_saved_address: "Sélectionner une adresse enregistrée...",
        ...
        toggle_currency: "Changer de devise",
        theme_light: "Clair",
        theme_dark: "Sombre",
    ...
    fa: {
        ...
        sitemap: "نقشه سایت",
        sitemap_title: "نقشه سایت",
        sitemap_intro: "همه‌ی صفحات سایت ما، در یک جا.",
        sitemap_main_pages: "صفحات اصلی",
        sitemap_categories: "دسته‌بندی محصولات",
        sitemap_products: "محصولات",
        sitemap_static_pages: "صفحات",
        sitemap_home: "صفحه اصلی",
        sitemap_all_products: "همه‌ی محصولات",
        download_brochure: "دانلود بروشور (PDF)",
        certified_and_licensed: "دارای گواهینامه و مجوز",
        our_team: "تیم ما",
        our_team_intro: "افرادی که پشت افتازون هستن.",
        our_team_empty: "پروفایل اعضای تیم به‌زودی اضافه می‌شه.",
        ...
        description_title: "توضیحات",
        related_equipment: "تجهیزات مرتبط",
        reference_label: "شماره مرجع:",
        warranty: "گارانتی",
        months_suffix: "ماه",
        results: "نتیجه",
        result: "نتیجه",
        ...
        use_saved_address: "استفاده از یک آدرس ذخیره‌شده",
        select_saved_address: "یک آدرس ذخیره‌شده انتخاب کنید...",
        ...
        toggle_currency: "تغییر واحد پول",
        theme_light: "روشن",
        theme_dark: "تیره",
        theme_system: "سیستم",
