...
return [
    ...
    'attributes' => [
        ...
        'warranty_months' => 'مدت گارانتی (ماه)',
        'is_checked' => 'بررسی‌شده بودن',
        'is_active' => 'فعال بودن',
        'is_published' => 'منتشرشده بودن',
        ...
        'site_name' => 'نام سایت',
        'slogan' => 'شعار سایت',
        'font_latin' => 'فونت لاتین',
        'font_persian' => 'فونت فارسی',
        'robots_txt' => 'محتوای robots.txt',
        'content' => 'محتوا',
        'label' => 'برچسب',
        'url' => 'آدرس',
        'location' => 'محل قرارگیری',
        'group_label' => 'عنوان گروه',
        'direction' => 'جهت',
        'image_display_style' => 'حالت نمایش تصویر',
        'page_id' => 'صفحه',
        'role' => 'نقش',
        ...
        // فیلدهای چندزبانه (JSON) — نسخه‌ی هر زبان با همون برچسب پایه
        'title.*' => 'عنوان',
        'name.*' => 'نام',
        'description.*' => 'توضیحات',
        'content.*' => 'محتوا',
